...
class TwitterUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter_user" do
    assert_difference('TwitterUser.count') do
      post twitter_users_url, params: { twitter_user: { twittter_id: @twitter_user.twittter_id, username: @twitter_user.username } }
    end
  ...
  test "should update twitter_user" do
    patch twitter_user_url(@twitter_user), params: { twitter_user: { twittter_id: @twitter_user.twittter_id, username: @twitter_user.username } }
